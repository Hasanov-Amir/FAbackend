...
class Tovar(models.Model):
    ...
    comments_count = models.IntegerField(default=0, verbose_name="Кол-во отзывов")
    recommendation = models.SmallIntegerField(null=True, verbose_name="Процент рекомендаций")
...
class Rating_andComments(models.Model):
    ...
    product = models.ForeignKey("Tovar", on_delete=models.CASCADE, verbose_name="Товар")
    rating = models.FloatField(default=0, verbose_name="Рейтинг")
    plus = models.TextField(null=True, verbose_name="Плюсы товара")
    minus = models.TextField(null=True, verbose_name="Минусы товара")
    comment = models.TextField(null=True, verbose_name="Комментарий")
    using_exp = models.TextField(null=True, verbose_name="Опыт использования")
